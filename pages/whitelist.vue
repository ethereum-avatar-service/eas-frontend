  ...
  <div class="py-16">
    <div class="px-4 mx-auto flex flex-col gap-12">
      <div class="flex flex-col gap-3">
        ...
        <p>Please read <a href="https://github.com/ethereum-avatar-service/eas-api-whitelist/blob/main/README.md" class="text-sky-500">here</a> on how to get a collection verified.</p>
      </div>
